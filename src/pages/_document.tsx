...
export default function Document() {
  return (
    <Html lang='en'>
      <Head />
      <meta name='application-name' content='Walls Research' />
      <meta name='apple-mobile-web-app-capable' content='yes' />
      <meta name='apple-mobile-web-app-status-bar-style' content='default' />
      <meta name='apple-mobile-web-app-title' content='Walls Research PWA' />
      <meta name='description' content={`Walls Research`} />
